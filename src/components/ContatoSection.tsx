    ...
    return (
        <div id="contact" className="bg-[#141414] flex flex-col justify-evenly items-center">
            ...
            <div className="Contacts flex w-[90%] justify-evenly text-white">
                <div onClick={handleCopyEmail} className={`${isCopiedEmail ? 'copied-animation' : ''} email cursor-pointer`}>
                ...
                <div onClick={handleCopyTel} className={`${isCopiedEmail ? 'copied-animation' : ''} tel cursor-pointer`}>
