    ...
    return (
        <section id="about" className="w-screen h-screen bg-[#FFFFFF] grid grid-cols-2 text-base">
            <div id="part1" className="bg-[#141414]">
                <div id="conteudo" className="max-w-[70%] m-auto flex flex-col justify-around h-full pb-[50px]" data-aos="fade-right">
                    <div className="h-16 w-16 mx-auto" id="logo">
                        <img src="./img/logo-grande.png" alt="" />
                    </div>
                    <div className="title text-white">
                        <h1 className="text-center text-6xl font-bold">Sobre mim</h1>
                    </div>
                    <div className="myDescription text-white">
                        <h2 className="text-center text-3xl font-normal">Meu nome é João Felipe Ribeiro da Silva, tenho 19 anos e sou natural de Cascavel, Paraná. </h2>
                    </div>
            ...
            <div id="part2" className="bg-[#FFCC00]">
                <div className="max-w-[70%] m-auto flex flex-col justify-around h-full" data-aos="fade-left">
